...
export function getstarterData() {
    ...
    .then(data => {
        let imageCheck = data.filter(element => {			
            if(element.coverimages[0] === "https://cover.biblion.nl/coverlist.dll?doctype=morebutton&bibliotheek=oba&style=0&ppn=172024889&isbn=9789065876966&lid=&aut=&ti=&size=70") {
                return true
            } else {
                return false
            }
