...
export function getstarterData() {
    ...
    .then(data => {
        ...
        const results = data.results;
            let imageCheck = results.filter(() =>
                results.coverimages[0] == "https://v112.nbc.bibliotheek.nl/thumbnail?uri=http://data.bibliotheek.nl/ggc/ppn/172024889&token=c1322402"
            );
        });
